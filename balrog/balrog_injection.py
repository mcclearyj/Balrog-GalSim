...
class Tile(object):
    ...
    def __init__(self, tile_name, config, realization=0):
        ...
        #self._load_zeropoints(config) -- not general to non-DES images
    ...
    def _set_wcs(self, config):
        ...
        try:
            ...
            # Set pixel information
            self.pixel_scale = 0.268 # Have to set by hand 
    ...
    def _create_chip_list(self, config):
        ...
        for band, b_dir in self.band_dir.items():
            ...
            for f in file_list:
                #if self.is_chip_image(config, f):
